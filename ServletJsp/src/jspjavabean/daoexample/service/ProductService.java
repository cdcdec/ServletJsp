package jspjavabean.daoexample.service;

import java.util.List;

import jspjavabean.daoexample.dao.ProductDao;
import jspjavabean.daoexample.dao.ProductDaoImpl;
import jspjavabean.daoexample.db.DBConnection;
...
public class ProductService implements ProductDao{
	...
	@Override
	public String findMaxProductId() throws Exception {
		String id="";
		try {
			id = this.dao.findMaxProductId();// 调用实现方法
		} catch (Exception e) {
			throw e;
		} finally {
			this.dbconn.close();
