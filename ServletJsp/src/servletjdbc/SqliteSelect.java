...
/**
 * Servlet implementation class SqliteSelect
 */
@WebServlet(name = "SqliteSelect", urlPatterns = { "/SqliteSelect" })
public class SqliteSelect extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<HTML>");
		out.println("  <HEAD><TITLE>sqlite3 select</TITLE></HEAD>");
		out.println("  <BODY>");
		Connection c = null;
		Statement stmt = null;
		try {
